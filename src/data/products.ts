...
export const products: Product[] = [
  ...
  },
  {
    ...
    brewingRitual: [
      { step: "01", title: "Dip", description: "Place the leaf dip bag in your favorite ceramic mug." },
  ...
  },
  {
    ...
    brewingRitual: [
      { step: "01", title: "Steep", description: "Dip the mature leaf bag in near-boiling water." },
