...
export default function Home() {
  ...
  const reviews = [
    {
      text: "The best Herbal Tea! Wow! Keep sipping, keep glowing. Nalam Brews' blends are truly transformational.",
      author: "Arshi",
  ...
  const heroSlides = [
    {
      tagline: "🌿 Pure Botanical Nutrition • Modern Dip Soups",
      titlePart1: "Level Up Your",
      titlePart2: "Daily Routine",
      description: "Diptox with 100% natural, hand-plucked botanical leaf infusions. Nurtured by Indian farmer families for premium lifestyle health soups.",
    ...
    },
    {
      ...
      description: "Lightweight and clean botanical health soups in a convenient modern dip bag. Experience deep hydration without any of the jittery caffeine.",
  ...
  return (
    <div className="bg-[#FAFDF6] text-[#1e2f14] space-y-0">
      
      {/* 16:9 Responsive Automatic Hero Carousel */}
      <section className="max-w-7xl mx-auto px-4 md:px-16 pt-6 md:pt-10 pb-4">
        <div className="relative aspect-[16/10] sm:aspect-video md:aspect-[16/7] lg:aspect-[16/6] w-full rounded-2xl md:rounded-3xl overflow-hidden shadow-md bg-[#1e2f14] group">
          {/* Slides */}
                ...
                <div className="absolute inset-0 flex items-center">
                  <div className="px-6 sm:px-12 md:px-16 lg:px-24 max-w-3xl space-y-2 sm:space-y-4 md:space-y-5 lg:space-y-6 text-white text-left">
                    <motion.span 
                      ...
                      className="inline-block font-sans text-[10px] sm:text-xs uppercase tracking-[0.3em] font-extrabold text-[#c2e88d] bg-white/10 backdrop-blur-md px-3 sm:px-4 py-1 sm:py-1.5 rounded-full"
                    >
                    ...
                    <h1 className="font-serif text-xl sm:text-3xl md:text-5xl lg:text-6xl font-extrabold leading-[1.15]">
                      ...
                      <span className="italic text-[#c2e88d]">{heroSlides[activeHeroSlide].titlePart2}</span>
                    </h1>
                    ...
                    <div className="flex gap-3 pt-1 sm:pt-2">
                      {heroSlides[activeHeroSlide].ctaLink.startsWith("#") ? (
                        <a 
                          ...
                          className="px-4 sm:px-8 py-1.5 sm:py-3 bg-[#fde047] hover:bg-[#eab308] text-[#1e2f14] rounded-full font-sans text-[10px] sm:text-xs md:text-sm font-bold uppercase tracking-wider transition-all shadow-md active:scale-97 cursor-pointer"
                        >
      ...
      <section className="py-12 bg-[#f4f9eb]">
        <div className="max-w-7xl mx-auto px-5 md:px-16">
          <div className="bg-white rounded-3xl p-6 md:p-10 border border-outline-variant/30 flex flex-col md:flex-row items-center justify-between gap-8 shadow-sm">
            <div className="space-y-3 max-w-xl text-center md:text-left">
              ...
              <h3 className="font-serif text-2xl md:text-3xl font-extrabold text-on-surface">Get 7 Premium Health Soup Combo Box</h3>
              <p className="text-xs md:text-sm text-[#1e2f14]/80">Start your holistic wellness routine today with 7 specialized dip soups designed for daily restoration.</p>
            </div>
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
              <div className="text-center md:text-right">
                <span className="text-sm line-through text-on-surface-variant block">Regular ₹1,999</span>
                <span className="font-serif text-3xl font-black text-[#48671c] block">₹999 Only</span>
              </div>
              <button 
                onClick={() => {
                ...
                className="w-full sm:w-auto px-8 py-3.5 bg-[#48671c] hover:bg-[#344d13] text-white font-bold text-xs uppercase tracking-widest rounded-xl transition-all shadow-md cursor-pointer"
              >
                Claim Package
              </button>
            </div>
      ...
      <section id="categories" className="py-20 max-w-7xl mx-auto px-4 md:px-16">
        <div className="text-center mb-16 space-y-4">
          <span className="text-xs uppercase tracking-[0.3em] font-extrabold text-[#48671c]">The Healing Portfolio</span>
          <h2 className="font-serif text-4xl md:text-6xl font-bold">
            Explore our <span className="italic text-[#48671c]">Botanical Matrix</span>
          </h2>
        ...
        <div className="border-b border-outline-variant/20 pb-12 mb-16">
          ...
          <CategorySwiper
            ...
            bannerImage="https://lh3.googleusercontent.com/aida-public/AB6AXuB0YMYIgrbvHULe2hMJO0vYKzEG7lNpNEvxIlic5hGJm_hQsNO3eXsePgcF92KjWGxXIAdpjjuMxB8JoYWCGosle9qv-YQBSX6rvdE1abVUZC-Rfx2dfIKSEVIFnL8kazTkMejf-bI_NhQuiUAVwZ7acThVbx7fkWDq8ufkW0o4X6w6GQ0EHKcg4babalqyicsl9FpOxW6AIsLX5zxSzppUJJpZNWxHZjCJND_epjF0bdJ14uowKuMP7ggy6SN17qgTSoJGtdNOHk3"
      ...
      <section className="bg-[#1e2f14] py-8 text-white select-none border-y border-white/5">
        <div className="max-w-7xl mx-auto px-5 md:px-16">
      ...
      <section className="py-16 bg-[#f4f9eb] border-y border-outline-variant/10 text-center">
        <div className="max-w-3xl mx-auto px-5 space-y-6">
          <span className="text-[#48671c] font-black text-xs uppercase tracking-[0.25em] bg-white px-4 py-1.5 rounded-full border border-outline-variant/20 shadow-xs inline-block">
            🌱 The Complete Catalogue
          </span>
          <h2 className="font-serif text-3xl md:text-5xl font-extrabold text-[#1E2F14]">
            Can't find what you are looking for?
          </h2>
          <p className="text-on-surface-variant max-w-lg mx-auto text-sm md:text-base">
            Discover our entire spectrum of herbal health soups in the shape of dips.
          </p>
          <div className="pt-4">
            <Link 
              to="/products"
              className="px-10 py-4.5 bg-[#48671c] hover:bg-[#344d13] text-white rounded-full font-serif text-base font-bold shadow-md hover:scale-103 transition-all inline-block cursor-pointer"
            >
      ...
      <section className="py-24 bg-white border-y border-outline-variant/10">
        <div className="max-w-4xl mx-auto px-5 text-center space-y-8">
          <span className="text-xs uppercase tracking-[0.3em] font-black text-[#48671c] block">Tested & Approved</span>
          <h2 className="font-serif text-3xl md:text-5xl font-extrabold">The Voice of Our Customers</h2>
          
          {/* Review Slider */}
          <div className="relative bg-[#f4f9eb] rounded-3xl p-8 md:p-14 border border-outline-variant/30 shadow-xs">
            <Quote className="w-12 h-12 text-[#48671c]/25 mx-auto mb-6" />
            ...
            <div className="space-y-1">
              <h4 className="font-sans font-extrabold text-sm text-[#1e2f14]">
              ...
              {reviews.map((_, i) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-300 ${
                    activeReviewIndex === i ? 'w-5 bg-[#48671c]' : 'w-1.5 bg-on-surface-variant/35'
                  }`}
      ...
      <section id="story" className="py-24 bg-[#f1f6ea] overflow-hidden">
        <div className="max-w-7xl mx-auto px-5 md:px-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            <div className="absolute inset-0 bg-[#48671c]/10 rounded-[3rem] -rotate-3 scale-103" />
            <motion.div 
          ...
          <div className="space-y-8">
            <span className="font-sans text-xs uppercase tracking-[0.3em] font-extrabold text-[#48671c] bg-[#48671c]/10 px-3 py-1.5 rounded-full w-fit block">Our Story & Farmer Heritage</span>
            <h2 className="font-serif text-4xl md:text-5xl leading-tight text-on-surface font-extrabold">
              Nurturing Over <br />
              <span className="italic text-[#48671c] font-light">1,000 Farmer Families</span>
            </h2>
            <div className="space-y-6 text-on-surface-variant text-sm md:text-base leading-relaxed">
              <p>
                Our vision is to provide authentic Indian herbal health soups across the world and while on this journey, we commit to the advancement of our community along with us. We are proud to change the lives of over 1,000 farmer's families.
              </p>
              <p>
              ...
              <p className="font-semibold text-on-surface flex items-center gap-2">
                🇮🇳 <span className="text-[#48671c]">90% of our farmers are passionate rural women</span>, inspiring true economic independence and sustainable progress in native sectors.
              </p>
            </div>
            
            <div className="flex flex-col sm:flex-row gap-6 pt-4 border-t border-outline-variant/35 text-center sm:text-left">
              <div>
                <h4 className="font-serif text-3xl font-black text-[#48671c]">100%</h4>
              ...
              <div>
                <h4 className="font-serif text-3xl font-black text-[#48671c]">1,000+</h4>
                <p className="text-xs text-on-surface-variant font-bold uppercase tracking-wider">Local Farms Uplifted</p>
              </div>
              <div className="hidden sm:block border-r border-outline-variant/35" />
              <div>
                <h4 className="font-serif text-3xl font-black text-[#48671c]">90%</h4>
      ...
      <section className="py-24 px-5">
        <div className="max-w-7xl mx-auto relative rounded-[3rem] overflow-hidden bg-[#1e2f14] p-12 md:p-24 text-center border border-white/5 shadow-2x">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-6">
            <Leaf className="w-10 h-10 text-[#c2e88d] mx-auto animate-pulse" />
            <h2 className="font-serif text-4xl md:text-6xl text-white mb-8 leading-tight font-extrabold">
              Cultivate Your Inner <span className="italic font-light text-[#c2e88d]">Daily Balance</span>.
            </h2>
            <p className="text-white/80 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
              Begin your natural journey towards holistic wellness today with our sustainably harvested whole-leaf botanical dip soups.
            </p>
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-fit mx-auto pt-6">
              <a href="#categories" className="px-10 py-5 bg-[#c2e88d] hover:bg-white text-[#1e2f14] rounded-full font-serif text-lg font-bold shadow-xl transition-all block">
