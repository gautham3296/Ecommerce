        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-on-surface-variant">
              <li><Link to="/products" className="hover:text-primary transition-colors">Design Collection</Link></li>
          ...
          <div>
            <h4 className="font-sans text-xs uppercase tracking-[0.2em] font-bold text-primary mb-8">Concept</h4>
            <ul className="space-y-4 text-sm text-on-surface-variant">
              <li><a href="#story" className="hover:text-primary transition-colors">Our Story</a></li>
              <li><a href="#categories" className="hover:text-primary transition-colors">Segments</a></li>
              <li><Link to="/orders" className="hover:text-primary transition-colors">Craftsmanship</Link></li>
              <li><Link to="/admin" className="hover:text-primary transition-colors">Material Sourcing</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-sans text-xs uppercase tracking-[0.2em] font-bold text-primary mb-8">Newsletter</h4>
            <p className="text-sm text-on-surface-variant mb-6">Join our design digest for studio updates.</p>
